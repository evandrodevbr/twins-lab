...
function enviarDados() {
    return __awaiter(this, void 0, void 0, function () {
        var dadosCircuito, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.post('http://localhost:3000/api/dados', dadosCircuito)];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Erro ao enviar dados:', error_1);
                    return [3 /*break*/, 3];
